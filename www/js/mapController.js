...
let mapController = {
    ...
    InitalizeMap() {
        ...
        map = new google.maps.Map(document.getElementById('map'), {
            center: { lat: 53.900010, lng: 18.536883 },
            zoom: 7,
        ...
        for (i = 0; i < pharmacies.length; i++) {
            ...
            google.maps.event.addListener(marker, 'click', (function (pharmacy) {
                return function () {
                    ...
                    let content = pharmacy.properties.nazwa_apteki_new + ' (' + pharmacy.properties.calodobowa + ') <br />' + pharmacy.properties.ulica + ' ' + pharmacy.properties.nr + ', ' + pharmacy.properties.miejscowosc;
